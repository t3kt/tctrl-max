...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.0, 477.0, 149.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.5, 530.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "dict.unpack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 512.0, 477.0, 52.0, 22.0 ],
					"style" : "",
					"text" : "keys $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 440.5, 420.0, 30.0, 22.0 ],
					"style" : "",
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 252.333313, 291.0, 98.0, 22.0 ],
					"style" : "",
					"text" : "prepend append"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 187.0, 157.0, 52.0, 22.0 ],
					"style" : "",
					"text" : "getkeys"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 252.333313, 252.0, 27.0, 22.0 ],
					"style" : "",
					"text" : "iter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.5, 192.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 354.5, 349.0, 191.0, 27.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 174.5, 85.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "t b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 187.0, 207.0, 117.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.5, 24.0, 145.0, 22.0 ],
					"style" : "",
