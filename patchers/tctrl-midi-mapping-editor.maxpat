...
,
		"rect" : [ -1836.0, 137.0, 1534.0, 871.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 878.5, 116.0, 94.0, 64.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 445.574219, 783.5, 29.5, 22.0 ],
					"style" : "",
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 428.324219, 715.0, 64.0, 22.0 ],
					"style" : "",
					"text" : "update $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 391.324219, 715.0, 31.0, 22.0 ],
					"style" : "",
					"text" : "add"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 507.324219, 715.0, 112.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 391.324219, 659.0, 56.0, 22.0 ],
					"style" : "",
					"text" : "sel none"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 228.0, 701.0, 68.0, 22.0 ],
					"style" : "",
					"text" : "route none"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 391.324219, 613.0, 82.0, 22.0 ],
					"style" : "",
					"text" : "pv mappingid"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1183.0, 589.5, 29.5, 22.0 ],
					"style" : "",
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1072.0, 708.5, 99.0, 22.0 ],
					"style" : "",
					"text" : "s #0.mappingdef"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 1072.0, 651.5, 112.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 277.0, 745.0, 98.0, 22.0 ],
					"style" : "",
					"text" : "prepend remove"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.0, 663.5, 82.0, 22.0 ],
					"style" : "",
					"text" : "pv mappingid"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 186.0, 602.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 454.324219, 546.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 363.3125, 830.5, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 186.0, 543.0, 50.687504, 21.798828 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 454.324219, 496.0, 43.351563, 21.798828 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"readonly" : 1,
					"style" : "",
					"text" : "/vjzual3/_/app/chain1/warp:QQ"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 136.5, 663.5, 37.0, 22.0 ],
					"style" : "",
					"text" : "none"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.5, 745.0, 133.0, 22.0 ],
					"style" : "",
					"text" : "s tctrl.map.current.path"
				}
